    ...
    return (
        <Regist1Styled>
            ...
            <Regist1BoxContainer2Styled>
                ...
                <Regist1Box3Styled>
                    <Regist1Box4Styled src={previewImage1}/>
            ...
            <Regist1BoxContainer2Styled>
                ...
                <Regist1Box3Styled>
                    <Regist1Box4Styled src={previewImage2}/>
                    <Regist1InputButtonStyled
                        onClick={() => {
            ...
            <Regist1BoxContainer2Styled>
                ...
                <Regist1Box3Styled>
                    <Regist1Box4Styled src={previewImage3}/>
                    <Regist1InputButtonStyled
                        onClick={() => {
            ...
            <Regist1BoxContainer2Styled>
                ...
                <Regist1Box3Styled>
                    <Regist1Box4Styled src={previewImage4}/>
                    <Regist1InputButtonStyled
                        onClick={() => {
            ...
            <Regist1BoxContainer2Styled>
                ...
                <Regist1Box3Styled>
                    <Regist1Box4Styled src={previewImage5}/>
                    <Regist1InputButtonStyled
                        onClick={() => {
                ...
                {grid1Items.map((index) => (
                    <Regist2FlexContinaer2Styled key='grid1-{index}'>
                        ...
                        <Regist2FlexBox4Styled>
                            <Regist2FlexBox5Styled src={previewImage1.current[index]}/>
                            <input type="file"
                                   name="filename"
                                   accept="image/jpeg, image/png"
                                   ref={(a) => {
            ...
            <Regist2FlexContainer1Styled>
                ...
                {grid2Items.map((index) => (
                    <Regist2FlexContinaer2Styled key='grid2-{index}'>
                        ...
                        <Regist2FlexBox4Styled>
                            <Regist2FlexBox5Styled src={previewImage2.current[index]}/>
                            <input type="file"
                                   name="filename"
                                   accept="image/jpeg, image/png"
                                   ref={(a) => {
