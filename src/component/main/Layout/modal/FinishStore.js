            ...
            <div className={classes.container}>
                ...
                <div className={classes['finish-container']}>
                    <div className={classes['finish-inner']}>
                        <span className={classes['finish-span']}>영업을 종료하시겠습니까?</span>
                    </div>
                    <div className={classes['finish-bottom']}>
                        <button className={`${classes['finish-button']} ${classes['button-no']}`} onClick={props.onClose} >아니요</button>
                        {/* 종료 로직 */}
                        <button className={`${classes['finish-button']} ${classes['button-yes']}`} onClick={props.onClose} >네</button>
                    </div>
                </div>
            </div>
        </Modal>
